...
public class DaylyReport {
    ...
    */
    public WbForSave printReport (User user, LocalDateTime timestamp, DataSource dsR, DataSource dsRW) throws IOException, SQLException, ParseException, DecoderException {
        ...
        cell_3_1.setCellValue("Дата: " + stringTimestamp);
        cell_3_1.setCellStyle(headerStyleNoBold);
        CellRangeAddress period = new CellRangeAddress(2, 2, 0, 3);
        ...
        if (user.getTag().equals("User")) {
            cell_4_1.setCellValue("Пользователь: " + user.getUserName());
        } else {
            cell_4_1.setCellValue("Подразделение: " + user.getUserName());
        }
        CellRangeAddress userName = new CellRangeAddress(3, 3, 0, 3);
        ...
        SXSSFCell cell4_1 = row_5.createCell(0);
        cell4_1.setCellStyle(nowStyle);
        cell4_1.setCellValue("Отчет сформирован  " + now);
        CellRangeAddress nowDone = new CellRangeAddress(4, 4, 0, 3);
        ...
        row_9.setHeight((short) 1400);

        SXSSFCell cell_7_1 = row_7.createCell(0);
        cell_7_1.setCellStyle(tableHeaderStyle);
        cell_7_1.setCellValue("№ п/п");
        CellRangeAddress headerNum = new CellRangeAddress(6, 8, 0, 0);
        sh.addMergedRegion(headerNum);
        CellRangeAddress borderForNum = new CellRangeAddress(6, 8, 0, 0);
        ...
        cell_7_2.setCellValue("Наименование объекта");
        CellRangeAddress headerObj = new CellRangeAddress(6, 8, 1, 1);
        sh.addMergedRegion(headerObj);
        CellRangeAddress borderForObj = new CellRangeAddress(6, 8, 1, 1);
        ...
        cell_7_3.setCellValue("Адрес объекта");
        CellRangeAddress headerBranch = new CellRangeAddress(6, 8, 2, 2);
        sh.addMergedRegion(headerBranch);
        CellRangeAddress borderForBranch = new CellRangeAddress(6, 8, 2, 2);
        ...
        cell_7_4.setCellValue("Дата и время входа в состояние");
        CellRangeAddress headerFacility = new CellRangeAddress(6, 8, 3, 3);
        sh.addMergedRegion(headerFacility);
        CellRangeAddress borderForFacility = new CellRangeAddress(6, 8, 3, 3);
        ...
        cell_7_5.setCellValue("Тгмц");
        CellRangeAddress headerAddress = new CellRangeAddress(6, 8, 4, 4);
        sh.addMergedRegion(headerAddress);
        CellRangeAddress borderForAddress = new CellRangeAddress(6, 8, 4, 4);
        ...
        cell_7_6.setCellValue("Время измерения Тнв");
        CellRangeAddress headerZone = new CellRangeAddress(6, 8, 5, 5);
        sh.addMergedRegion(headerZone);
        CellRangeAddress borderForZone = new CellRangeAddress(6, 8, 5, 5);
        ...
        cell_7_7.setCellValue("Параметры теплосети");
        CellRangeAddress headerHeatNet = new CellRangeAddress(6, 6, 6, 13);
        sh.addMergedRegion(headerHeatNet);
        CellRangeAddress borderForHeatNet = new CellRangeAddress(6, 6, 6, 13);
        ...
        cell_8_7.setCellValue("Т1");
        SXSSFCell cell_9_7 = row_9.createCell(6);
        cell_9_7.setCellStyle(tableHeaderStyle);
        cell_9_7.setCellValue("Прямая");

        SXSSFCell cell_8_8 = row_8.createCell(7);
        cell_8_8.setCellStyle(tableHeaderStyle);
        cell_8_8.setCellValue("Т1");
        SXSSFCell cell_9_8 = row_9.createCell(7);
        cell_9_8.setCellStyle(tableHeaderStyle);
        cell_9_8.setCellValue("Время измерения параметра");
        sh.setColumnHidden(7, true);

        SXSSFCell cell_8_9 = row_8.createCell(8);
        cell_8_9.setCellStyle(tableHeaderStyle);
        cell_8_9.setCellValue("Т2");
        SXSSFCell cell_9_9 = row_9.createCell(8);
        cell_9_9.setCellStyle(tableHeaderStyle);
        cell_9_9.setCellValue("Обратная");

        SXSSFCell cell_8_10 = row_8.createCell(9);
        cell_8_10.setCellStyle(tableHeaderStyle);
        cell_8_10.setCellValue("Т2");
        SXSSFCell cell_9_10 = row_9.createCell(9);
        cell_9_10.setCellStyle(tableHeaderStyle);
        cell_9_10.setCellValue("Время измерения параметра");
        sh.setColumnHidden(9, true);

        SXSSFCell cell_8_11 = row_8.createCell(10);
        cell_8_11.setCellStyle(tableHeaderStyle);
        cell_8_11.setCellValue("P1");
        SXSSFCell cell_9_11 = row_9.createCell(10);
        cell_9_11.setCellStyle(tableHeaderStyle);
        cell_9_11.setCellValue("Прямая");

        SXSSFCell cell_8_12 = row_8.createCell(11);
        cell_8_12.setCellStyle(tableHeaderStyle);
        cell_8_12.setCellValue("P1");
        SXSSFCell cell_9_12 = row_9.createCell(11);
        cell_9_12.setCellStyle(tableHeaderStyle);
        cell_9_12.setCellValue("Время измерения параметра");
        sh.setColumnHidden(11, true);

        SXSSFCell cell_8_13 = row_8.createCell(12);
        cell_8_13.setCellStyle(tableHeaderStyle);
        cell_8_13.setCellValue("P2");
        SXSSFCell cell_9_13 = row_9.createCell(12);
        cell_9_13.setCellStyle(tableHeaderStyle);
        cell_9_13.setCellValue("Обратная");

        SXSSFCell cell_8_14 = row_8.createCell(13);
        cell_8_14.setCellStyle(tableHeaderStyle);
        cell_8_14.setCellValue("P2");
        SXSSFCell cell_9_14 = row_9.createCell(13);
        cell_9_14.setCellStyle(tableHeaderStyle);
        cell_9_14.setCellValue("Время измерения параметра");
        sh.setColumnHidden(13, true);

        SXSSFCell cell_7_15 = row_7.createCell(14);
        cell_7_15.setCellStyle(tableHeaderStyle);
        cell_7_15.setCellValue("Параметры отопления");
        CellRangeAddress headerHeatParam = new CellRangeAddress(6, 6, 14, 21);
        sh.addMergedRegion(headerHeatParam);
        CellRangeAddress borderForHeatParam = new CellRangeAddress(6, 6, 14, 21);
        ...
        cell_8_15.setCellValue("Т3");
        SXSSFCell cell_9_15 = row_9.createCell(14);
        cell_9_15.setCellStyle(tableHeaderStyle);
        cell_9_15.setCellValue("Прямая");

        SXSSFCell cell_8_16 = row_8.createCell(15);
        cell_8_16.setCellStyle(tableHeaderStyle);
        cell_8_16.setCellValue("Т3");
        SXSSFCell cell_9_16 = row_9.createCell(15);
        cell_9_16.setCellStyle(tableHeaderStyle);
        cell_9_16.setCellValue("Время измерения параметра");
        sh.setColumnHidden(15, true);

        SXSSFCell cell_8_17 = row_8.createCell(16);
        cell_8_17.setCellStyle(tableHeaderStyle);
        cell_8_17.setCellValue("Т4");
        SXSSFCell cell_9_17 = row_9.createCell(16);
        cell_9_17.setCellStyle(tableHeaderStyle);
        cell_9_17.setCellValue("Обратная");

        SXSSFCell cell_8_18 = row_8.createCell(17);
        cell_8_18.setCellStyle(tableHeaderStyle);
        cell_8_18.setCellValue("Т4");
        SXSSFCell cell_9_18 = row_9.createCell(17);
        cell_9_18.setCellStyle(tableHeaderStyle);
        cell_9_18.setCellValue("Время измерения параметра");
        sh.setColumnHidden(17, true);

        SXSSFCell cell_8_19 = row_8.createCell(18);
        cell_8_19.setCellStyle(tableHeaderStyle);
        cell_8_19.setCellValue("P3");
        SXSSFCell cell_9_19 = row_9.createCell(18);
        cell_9_19.setCellStyle(tableHeaderStyle);
        cell_9_19.setCellValue("Прямая");

        SXSSFCell cell_8_20 = row_8.createCell(19);
        cell_8_20.setCellStyle(tableHeaderStyle);
        cell_8_20.setCellValue("P3");
        SXSSFCell cell_9_20 = row_9.createCell(19);
        cell_9_20.setCellStyle(tableHeaderStyle);
        cell_9_20.setCellValue("Время измерения параметра");
        sh.setColumnHidden(19, true);

        SXSSFCell cell_8_21 = row_8.createCell(20);
        cell_8_21.setCellStyle(tableHeaderStyle);
        cell_8_21.setCellValue("P4");
        SXSSFCell cell_9_21 = row_9.createCell(20);
        cell_9_21.setCellStyle(tableHeaderStyle);
        cell_9_21.setCellValue("Обратная");

        SXSSFCell cell_8_22 = row_8.createCell(21);
        cell_8_22.setCellStyle(tableHeaderStyle);
        cell_8_22.setCellValue("P4");
        SXSSFCell cell_9_22 = row_9.createCell(21);
        cell_9_22.setCellStyle(tableHeaderStyle);
        cell_9_22.setCellValue("Время измерения параметра");
        sh.setColumnHidden(21, true);

        SXSSFCell cell_7_23 = row_7.createCell(22);
        cell_7_23.setCellStyle(tableHeaderStyle);
        cell_7_23.setCellValue("Параметры ГВС");
        CellRangeAddress headerGVSParam = new CellRangeAddress(6, 6, 22, 37);
        sh.addMergedRegion(headerGVSParam);
        CellRangeAddress borderForGVSParam = new CellRangeAddress(6, 6, 22, 37);
        ...
        cell_8_23.setCellValue("Т7");
        SXSSFCell cell_9_23 = row_9.createCell(22);
        cell_9_23.setCellStyle(tableHeaderStyle);
        cell_9_23.setCellValue("после ВВП I зона");

        SXSSFCell cell_8_24 = row_8.createCell(23);
        cell_8_24.setCellStyle(tableHeaderStyle);
        cell_8_24.setCellValue("Т7");
        SXSSFCell cell_9_24 = row_9.createCell(23);
        cell_9_24.setCellStyle(tableHeaderStyle);
        cell_9_24.setCellValue("Время измерения параметра");
        sh.setColumnHidden(23, true);

        SXSSFCell cell_8_25 = row_8.createCell(24);
        cell_8_25.setCellStyle(tableHeaderStyle);
        cell_8_25.setCellValue("T7`");
        SXSSFCell cell_9_25 = row_9.createCell(24);
        cell_9_25.setCellStyle(tableHeaderStyle);
        cell_9_25.setCellValue("после ВВП II зона");

        SXSSFCell cell_8_26 = row_8.createCell(25);
        cell_8_26.setCellStyle(tableHeaderStyle);
        cell_8_26.setCellValue("T7`");
        SXSSFCell cell_9_26 = row_9.createCell(25);
        cell_9_26.setCellStyle(tableHeaderStyle);
        cell_9_26.setCellValue("Время измерения параметра");
        sh.setColumnHidden(25, true);

        SXSSFCell cell_8_27 = row_8.createCell(26);
        cell_8_27.setCellStyle(tableHeaderStyle);
        cell_8_27.setCellValue("P7");
        SXSSFCell cell_9_27 = row_9.createCell(26);
        cell_9_27.setCellStyle(tableHeaderStyle);
        cell_9_27.setCellValue("ГВС на I зону");

        SXSSFCell cell_8_28 = row_8.createCell(27);
        cell_8_28.setCellStyle(tableHeaderStyle);
        cell_8_28.setCellValue("P7");
        SXSSFCell cell_9_28 = row_9.createCell(27);
        cell_9_28.setCellStyle(tableHeaderStyle);
        cell_9_28.setCellValue("Время измерения параметра");
        sh.setColumnHidden(27, true);

        SXSSFCell cell_8_29 = row_8.createCell(28);
        cell_8_29.setCellStyle(tableHeaderStyle);
        cell_8_29.setCellValue("P7`");
        SXSSFCell cell_9_29 = row_9.createCell(28);
        cell_9_29.setCellStyle(tableHeaderStyle);
        cell_9_29.setCellValue("ГВС на II зону");

        SXSSFCell cell_8_30 = row_8.createCell(29);
        cell_8_30.setCellStyle(tableHeaderStyle);
        cell_8_30.setCellValue("P7`");
        SXSSFCell cell_9_30 = row_9.createCell(29);
        cell_9_30.setCellStyle(tableHeaderStyle);
        cell_9_30.setCellValue("Время измерения параметра");
        sh.setColumnHidden(29, true);

        SXSSFCell cell_8_31 = row_8.createCell(30);
        cell_8_31.setCellStyle(tableHeaderStyle);
        cell_8_31.setCellValue("Т13");
        SXSSFCell cell_9_31 = row_9.createCell(30);
        cell_9_31.setCellStyle(tableHeaderStyle);
        cell_9_31.setCellValue("В циркуляц. линии I зоны");

        SXSSFCell cell_8_32 = row_8.createCell(31);
        cell_8_32.setCellStyle(tableHeaderStyle);
        cell_8_32.setCellValue("Т13");
        SXSSFCell cell_9_32 = row_9.createCell(31);
        cell_9_32.setCellStyle(tableHeaderStyle);
        cell_9_32.setCellValue("Время измерения параметра");
        sh.setColumnHidden(31, true);

        SXSSFCell cell_8_33 = row_8.createCell(32);
        cell_8_33.setCellStyle(tableHeaderStyle);
        cell_8_33.setCellValue("T13`");
        SXSSFCell cell_9_33 = row_9.createCell(32);
        cell_9_33.setCellStyle(tableHeaderStyle);
        cell_9_33.setCellValue("В циркуляц. линии II зоны");

        SXSSFCell cell_8_34 = row_8.createCell(33);
        cell_8_34.setCellStyle(tableHeaderStyle);
        cell_8_34.setCellValue("T13`");
        SXSSFCell cell_9_34 = row_9.createCell(33);
        cell_9_34.setCellStyle(tableHeaderStyle);
        cell_9_34.setCellValue("Время измерения параметра");
        sh.setColumnHidden(33, true);

        SXSSFCell cell_8_35 = row_8.createCell(34);
        cell_8_35.setCellStyle(tableHeaderStyle);
        cell_8_35.setCellValue("P13");
        SXSSFCell cell_9_35 = row_9.createCell(34);
        cell_9_35.setCellStyle(tableHeaderStyle);
        cell_9_35.setCellValue("В циркуляц. линии I зоны");

        SXSSFCell cell_8_36 = row_8.createCell(35);
        cell_8_36.setCellStyle(tableHeaderStyle);
        cell_8_36.setCellValue("P13");
        SXSSFCell cell_9_36 = row_9.createCell(35);
        cell_9_36.setCellStyle(tableHeaderStyle);
        cell_9_36.setCellValue("Время измерения параметра");
        sh.setColumnHidden(35, true);

        SXSSFCell cell_8_37 = row_8.createCell(36);
        cell_8_37.setCellStyle(tableHeaderStyle);
        cell_8_37.setCellValue("P13`");
        SXSSFCell cell_9_37 = row_9.createCell(36);
        cell_9_37.setCellStyle(tableHeaderStyle);
        cell_9_37.setCellValue("В циркуляц. линии II зоны");

        SXSSFCell cell_8_38 = row_8.createCell(37);
        cell_8_38.setCellStyle(tableHeaderStyle);
        cell_8_38.setCellValue("P13`");
        SXSSFCell cell_9_38 = row_9.createCell(37);
        cell_9_38.setCellStyle(tableHeaderStyle);
        cell_9_38.setCellValue("Время измерения параметра");
        sh.setColumnHidden(37, true);

        SXSSFCell cell_7_39 = row_7.createCell(38);
        cell_7_39.setCellStyle(tableHeaderStyle);
        cell_7_39.setCellValue("Параметры ХВС");
        CellRangeAddress headerHVSParam = new CellRangeAddress(6, 6, 38, 43);
        sh.addMergedRegion(headerHVSParam);
        CellRangeAddress borderForHVSParam = new CellRangeAddress(6, 6, 38, 43);
        ...
        cell_8_39.setCellValue("Pгор.хв");
        SXSSFCell cell_9_39 = row_9.createCell(38);
        cell_9_39.setCellStyle(tableHeaderStyle);
        cell_9_39.setCellValue("В горводопроводе");

        SXSSFCell cell_8_40 = row_8.createCell(39);
        cell_8_40.setCellStyle(tableHeaderStyle);
        cell_8_40.setCellValue("Pгор.хв");
        SXSSFCell cell_9_40 = row_9.createCell(39);
        cell_9_40.setCellStyle(tableHeaderStyle);
        cell_9_40.setCellValue("Время измерения параметра");
        sh.setColumnHidden(39, true);

        SXSSFCell cell_8_41 = row_8.createCell(40);
        cell_8_41.setCellStyle(tableHeaderStyle);
        cell_8_41.setCellValue("Pхв");
        SXSSFCell cell_9_41 = row_9.createCell(40);
        cell_9_41.setCellStyle(tableHeaderStyle);
        cell_9_41.setCellValue("На выходе из ЦТП на I зону");

        SXSSFCell cell_8_42 = row_8.createCell(41);
        cell_8_42.setCellStyle(tableHeaderStyle);
        cell_8_42.setCellValue("Pхв");
        SXSSFCell cell_9_42 = row_9.createCell(41);
        cell_9_42.setCellStyle(tableHeaderStyle);
        cell_9_42.setCellValue("Время измерения параметра");
        sh.setColumnHidden(41, true);

        SXSSFCell cell_8_43 = row_8.createCell(42);
        cell_8_43.setCellStyle(tableHeaderStyle);
        cell_8_43.setCellValue("Pхв`");
        SXSSFCell cell_9_43 = row_9.createCell(42);
        cell_9_43.setCellStyle(tableHeaderStyle);
        cell_9_43.setCellValue("На выходе из ЦТП на II зону");

        SXSSFCell cell_8_44 = row_8.createCell(43);
        cell_8_44.setCellStyle(tableHeaderStyle);
        cell_8_44.setCellValue("Pхв`");
        SXSSFCell cell_9_44 = row_9.createCell(43);
        cell_9_44.setCellStyle(tableHeaderStyle);
        cell_9_44.setCellValue("Время измерения параметра");
        sh.setColumnHidden(43, true);

        SXSSFCell cell_7_45 = row_7.createCell(44);
        cell_7_45.setCellStyle(tableHeaderStyle);
        cell_7_45.setCellValue("Показания счетчиков");
        CellRangeAddress headerMetData = new CellRangeAddress(6, 6, 44, 53);
        sh.addMergedRegion(headerMetData);
        CellRangeAddress borderForMetData = new CellRangeAddress(6, 6, 44, 53);
        ...
        cell_8_45.setCellValue("Qтс");
        SXSSFCell cell_9_45 = row_9.createCell(44);
        cell_9_45.setCellStyle(tableHeaderStyle);
        cell_9_45.setCellValue("Расход тепла");

        SXSSFCell cell_8_46 = row_8.createCell(45);
        cell_8_46.setCellStyle(tableHeaderStyle);
        cell_8_46.setCellValue("Qтс");
        SXSSFCell cell_9_46 = row_9.createCell(45);
        cell_9_46.setCellStyle(tableHeaderStyle);
        cell_9_46.setCellValue("Время измерения параметра");
        sh.setColumnHidden(45, true);

        SXSSFCell cell_8_47 = row_8.createCell(46);
        cell_8_47.setCellStyle(tableHeaderStyle);
        cell_8_47.setCellValue("Gп");
        SXSSFCell cell_9_47 = row_9.createCell(46);
        cell_9_47.setCellStyle(tableHeaderStyle);
        cell_9_47.setCellValue("Водомер на подпитке");

        SXSSFCell cell_8_48 = row_8.createCell(47);
        cell_8_48.setCellStyle(tableHeaderStyle);
        cell_8_48.setCellValue("Gп");
        SXSSFCell cell_9_48 = row_9.createCell(47);
        cell_9_48.setCellStyle(tableHeaderStyle);
        cell_9_48.setCellValue("Время измерения параметра");
        sh.setColumnHidden(47, true);

        SXSSFCell cell_8_49 = row_8.createCell(48);
        cell_8_49.setCellStyle(tableHeaderStyle);
        cell_8_49.setCellValue("Расх. ЭЭ");
        SXSSFCell cell_9_49 = row_9.createCell(48);
        cell_9_49.setCellStyle(tableHeaderStyle);
        cell_9_49.setCellValue("Общий расход электроэнергии");

        SXSSFCell cell_8_50 = row_8.createCell(49);
        cell_8_50.setCellStyle(tableHeaderStyle);
        cell_8_50.setCellValue("Расх. ЭЭ");
        SXSSFCell cell_9_50 = row_9.createCell(49);
        cell_9_50.setCellStyle(tableHeaderStyle);
        cell_9_50.setCellValue("Время измерения параметра");
        sh.setColumnHidden(49, true);

        SXSSFCell cell_8_51 = row_8.createCell(50);
        cell_8_51.setCellStyle(tableHeaderStyle);
        cell_8_51.setCellValue("Расх. Эхвс");
        SXSSFCell cell_9_51 = row_9.createCell(50);
        cell_9_51.setCellStyle(tableHeaderStyle);
        cell_9_51.setCellValue("Расход электроэнергии на насосы ХВС");

        SXSSFCell cell_8_52 = row_8.createCell(51);
        cell_8_52.setCellStyle(tableHeaderStyle);
        cell_8_52.setCellValue("Расх. Эхвс");
        SXSSFCell cell_9_52 = row_9.createCell(51);
        cell_9_52.setCellStyle(tableHeaderStyle);
        cell_9_52.setCellValue("Время измерения параметра");
        sh.setColumnHidden(51, true);

        SXSSFCell cell_8_53 = row_8.createCell(52);
        cell_8_53.setCellStyle(tableHeaderStyle);
        cell_8_53.setCellValue("V8");
        SXSSFCell cell_9_53 = row_9.createCell(52);
        cell_9_53.setCellStyle(tableHeaderStyle);
        cell_9_53.setCellValue("Расход холодной воды на нужды ГВС");

        SXSSFCell cell_8_54 = row_8.createCell(53);
        cell_8_54.setCellStyle(tableHeaderStyle);
        cell_8_54.setCellValue("V8");
        SXSSFCell cell_9_54 = row_9.createCell(53);
        cell_9_54.setCellStyle(tableHeaderStyle);
        cell_9_54.setCellValue("Время измерения параметра");
        sh.setColumnHidden(53, true);

        SXSSFCell cell_7_55 = row_7.createCell(54);
        cell_7_55.setCellStyle(tableHeaderStyle);
        cell_7_55.setCellValue("Комментарий");
        CellRangeAddress headerComment = new CellRangeAddress(6, 8, 54, 54);
        sh.addMergedRegion(headerComment);
        CellRangeAddress borderForComment = new CellRangeAddress(6, 8, 54, 54);
        ...
        SXSSFCell cell_7_56 = row_7.createCell(55);
        cell_7_56.setCellStyle(tableHeaderStyle);
        cell_7_56.setCellValue("Имя прикрепленного файла");
        CellRangeAddress headerFileName = new CellRangeAddress(6, 8, 55, 55);
        sh.addMergedRegion(headerFileName);
        CellRangeAddress borderForFileName = new CellRangeAddress(6, 8, 55, 55);
        ...
        SXSSFCell cell_7_57 = row_7.createCell(56);
        cell_7_57.setCellStyle(tableHeaderStyle);
        cell_7_57.setCellValue("Прикрепленный файл");
        CellRangeAddress headerFile = new CellRangeAddress(6, 8, 56, 56);
        sh.addMergedRegion(headerFile);
        CellRangeAddress borderForFile = new CellRangeAddress(6, 8, 56, 56);
